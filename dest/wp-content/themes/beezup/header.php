...
<html <?php language_attributes(); ?> class='no-js'>
	...
	<head>
		...
		<script>
			...
			})(window,document,'script','dataLayer','GTM-PMVMLQM');
		</script>
	...
	<body <?php body_class('wrapper-sticky'); ?>>
		...
		<noscript>
			<iframe src='https://www.googletagmanager.com/ns.html?id=GTM-PMVMLQM' height='0' width='0' style='display:none;visibility:hidden'></iframe>
		</noscript>
