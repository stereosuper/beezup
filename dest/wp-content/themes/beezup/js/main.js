...
module.exports = function (windowWidth, tempo) {
    ...
    function animMapping(svg) {
        ...
        var cable1 = svg.find('#cable1'),
            cable2 = svg.find('#cable2');

        tl.set([cable1, cable2], { drawSVG: 0 }).to(cable1, tempo, { drawSVG: '0% 100%', ease: easeIn }).to(cable1, tempo, { drawSVG: '100% 100%', ease: easeOut }).to(cable2, tempo, { drawSVG: '0% 100%', ease: easeIn, delay: tempo * 2 }).to(cable2, tempo, { drawSVG: '100% 100%', ease: easeOut });
    }
    ...
    function animImpact(svg) {
        ...
        tl.set(cable, { drawSVG: 0 }).to(cable, tempo, { drawSVG: '0% 100%', ease: easeOut, delay: tempo }).to(cable, tempo, { drawSVG: '100% 100%', ease: easeOut, delay: tempo * 2 });
    }
    ...
    function animChoose(svg) {
        ...
        tlBox.to(c1, tempo, { opacity: 1, ease: easeIn }).to(c1, tempo * 2, { y: 0, ease: bounce, delay: -tempo }).to(c2, tempo, { opacity: 1, ease: easeIn, delay: tempo * 2 }).to(c2, tempo * 2, { y: 0, ease: bounce, delay: -tempo }).to(c3, tempo, { opacity: 1, ease: easeIn, delay: tempo * 2 }).to(c3, tempo * 2, { y: 0, ease: bounce, delay: -tempo }).to(c4, tempo, { opacity: 1, ease: easeIn, delay: tempo * 2 }).to(c4, tempo * 2, { y: 0, ease: bounce, delay: -tempo });
    ...
    function animOrders(svg) {
        ...
        function loopMove() {
            ...
            if (loop === 1) {
                tl.to(boxes, tempo, { x: '+=' + xMove, y: '+=' + yMove, ease: easeOut, delay: tempo * 4 }).to(box3, tempo, { y: '-=50', opacity: 0, ease: revBounce, onCompleteParams: [box3, 3], onComplete: resetLast });
            } else if (loop === 3) {
                tl.to(boxes, tempo, { x: '+=' + xMove, y: '+=' + yMove, ease: easeOut, delay: tempo * 4 }).to(box2, tempo, { y: '-=50', opacity: 0, ease: revBounce, onCompleteParams: [box2, 1], onComplete: resetLast });
            } else if (loop === 4) {
                tl.to(boxes, tempo, { x: '+=' + xMove, y: '+=' + yMove, ease: easeOut, delay: tempo * 4 }).to(box1, tempo, { y: '-=50', opacity: 0, ease: revBounce, onCompleteParams: [box1, 0], onComplete: resetLast });
            } else {
