        ...
        <?php if( get_field('bottomText') ){ ?>
            <section class='demo-bottom'>
                <div class='demo-bottom-text'>
                    ...
                    <button class='btn-arrow btn' onclick="Calendly.showPopupWidget('https://calendly.com/communication-beezup');return false;" type='button'><?php the_field('bottomBtn'); ?><svg class='icon'><use xlink:href='#icon-arrow-right'></use></svg></button>
                 <?php } ?>
                </div>
