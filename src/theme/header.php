...
<html <?php language_attributes(); ?> class='no-js'>
	...
	<head>
		...
		<script>
			...
			})(window,document,'script','dataLayer','GTM-TSMVR9W');
		</script>
	...
	<body <?php body_class('wrapper-sticky'); ?>>
		...
		<noscript>
			<iframe src='https://www.googletagmanager.com/ns.html?id=GTM-TSMVR9W' height='0' width='0' style='display:none;visibility:hidden'></iframe>
		</noscript>
