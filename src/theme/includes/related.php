...
//        }
        ...
        if( $relatedQuery->have_posts() ){ ?>
            <h2 class='h1 align-small related-posts-top'><?php _e('Latest posts', 'beezup'); ?></h2>
...
//    }
    ...
    if( $categories ){
        ...
        if( $relatedQuery->have_posts() ){ ?>
            <h2 class='h1 align-small related-posts-top'><?php _e('Related Posts', 'beezup'); ?></h2>
