<div id="sib_embed_signup">
    <div class="forms-builder-wrapper">
        ...
        <form class="description sib-form" id="theform" name="theform" action="https://my.sendinblue.com/users/subscribeembed/js_id/2kqou/id/1" onsubmit="return false;">
            <input type="hidden" name="js_id" id="js_id" value="2kqou">
            <input type="hidden" name="listid" id="listid" value="50|63">
